 ...
 * or it can be obtained directly from a {@link ArtemisProvider}
 * via the {@link ArtemisProvider#expressionBuilder()} method.
 *
 * <p>The following is a simple example of how an instance of this class might be used to build a
 * SQL expression, where {@code table} might be a {@link String} object and {@code options} is a
 *
 * <pre>
 ...
 * </pre>
 * Note how the {@link String} elements are properly quoted using the {@link IdentifierRules}
 * that are passed to the builder's constructor.
 *
 * <p>This class is often used within a {@link ArtemisProvider} implementation to construct the
...
public class ExpressionBuilder {
    ...
    public interface Expressable {
         ...
         */
        void appendTo(ExpressionBuilder builder);
    }
     ...
     * {@link Expressable#appendTo(ExpressionBuilder)} method. Otherwise, the string
